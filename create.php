        ...
        <div class = "card">
            ...
            <div class="card-body">
                ...
                <div class = "control-group <?php echo !empty($enderecoErro)? 'error': ''; ?>">
                   ...
                   <div class = "controls">
                    <input size="80" class="form-control" name="enderco" type="text" placeholder="Endereço"
...
<script src = "https://code.jquery.com/jquery-3.3.1.js" integrity="sha256-2Kok7MbOyxpgUVvAK/HJ2jigOSYS2auK4Pfzbm7uH60-"
                                crossoringin="anonymus"></script>                                
<script src="https://cnjs.cloudflare.com/ajax/libs/popper.js/1.14.3/umd/popper.min.js"
        intefrity="sha384-ZMP7rVo3mIyKV+2+933UJ46jBk0WLaUAdn689aCwoqbBJiSnjAK/l8WvCWPIPm49"
